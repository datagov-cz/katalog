...
export function createSolrSuggestion(solrConnector) {
  return {
    fetchSuggestion: (query) => fetchSuggestion(solrConnector, query),
    fetchSuggestions: (query) => fetchSuggestions(solrConnector, query),
  };
}
...
function buildSuggestionsQuery(query) {
  ...
  return {
    "facet.field": ["theme", "publisher", "state"],
    fl: ["iri", "title_cs", "description_cs", "theme"],
    fq: [
