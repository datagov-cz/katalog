...
export function prepareTemplateData(
  ...
  return {
    ...
    search: {
      ...
      "search-href": navigation.linkFromServer({
        ...query,
        searchQuery: "_QUERY_",
        page: 0,
      }),
    },
    "result-bar": components.createResultBarData(
      translation,
      navigation,
      query,
      SORT_OPTIONS,
    ...
    pagination: components.createPaginationData(
      navigation,
      query,
      applicationCount,
    ),
...
function prepareDocumentsInPlace(navigation, suggestions) {
  const suggestionDetailNavigation = navigation.changeView(
